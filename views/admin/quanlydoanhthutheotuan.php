<div class="table-responsive">
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            $sql = "SELECT * FROM baocaodoanhthu where Year(NgayLap) =" . $date['year'] . " AND MONTH(NgayLap) = " . $date['mon'] . " AND Day(NgayLap) BETWEEN " . $day . " AND " . $date['mday'] . " Order by MaHoaDon ASC";
