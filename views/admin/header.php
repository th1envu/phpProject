...
if (isset($_GET["page_layout"])) {
    switch ($_GET["page_layout"]) {
        ...
        case 'hoaDonBan':
            ...
            break;
        case 'hoaDonNhap':
            header('location: ../admin/quanLyHoaDonNhap.php');
            break;
        case 'loaiSP':
            ...
            <ul class="sidebar-menu do-nicescrol">
                ...
                <li>
                    <a href="index.php?page_layout=chiTietHoaDonNhap">
                        <i class="zmdi zmdi-view-dashboard"></i> <span>Chi tiết hóa đơn nhập</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="index.php?page_layout=hoaDonBan">
                        <i class="zmdi zmdi-view-dashboard"></i> <span>Quản lý hóa đơn bán</span>
                    </a>
                </li>
                <li>
                    <a href="index.php?page_layout=hoaDonNhap">
                        <i class="zmdi zmdi-view-dashboard"></i> <span>Quản lý hóa đơn nhập</span>
                    </a>
                </li>
                <li>
